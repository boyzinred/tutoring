...
```css
:root {
  --light-background: #D35D4A;
  --light-foreground: #68B9DE;
  --light-primary: #11328D;
  --light-primary-hover: #FFEB09;
  --light-secondary: #1648D2;
  --light-secondary-soft: #FFEB09;
  --light-accent: #F0D7A8;
  --light-accent-soft: #F0D7A8;
  --light-muted: #B6EBA2;
  --light-muted-strong: #99C588;
  --light-blue-soft: #A4483B;
  --light-border: #EACF86;
  --light-subtle: #B3DA58;
}
...
html[data-theme='dark'] {
  ...
  --light-primary: #809DF0;
  --light-primary-hover: #F9EE6D;
  --light-secondary: #7E9DF1;
  --light-secondary-soft: #423D0B;
  --light-accent: #E3B35A;
  --light-accent-soft: #412F0B;
  --light-muted: #1F2937;
  --light-muted-strong: #374151;
  --light-blue-soft: #381914;
  --light-border: #374151;
  --light-subtle: #CBD5E1;
}
